...
/* Bounded decoder used by the HWPML attachment callback. This remains an
 * internal interface; it is declared so low-memory regression tests can
 * exercise boundary carry, malformed input, and fail-visible propagation. */
