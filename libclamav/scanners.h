...
/**
 * @brief Identify scan results that must stop later parser or matcher work.
 *
 * Non-critical parser, decoder, and ABI failures remain fail-visible but do
 * not suppress independent later matcher signatures.
 */
