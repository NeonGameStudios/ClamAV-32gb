...
/**
 * Enforce the bounded contiguous-subject policy used by PCRE matching.
 * PCREMaxFileSize values of zero or above CLI_MAX_ALLOCATION are constrained
 * to CLI_MAX_ALLOCATION. Exceeding the effective limit marks a real scan
 * incomplete and returns CL_EMAXSIZE.
 */
