...
typedef char cli_pcre_meta_abi_size[(sizeof(struct cli_pcre_meta) == 136) ? 1 : -1];
typedef char cli_pcre_meta_abi_offdata[(offsetof(struct cli_pcre_meta, offdata) == 64) ? 1 : -1];
