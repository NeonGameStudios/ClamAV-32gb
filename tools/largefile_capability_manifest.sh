...
required_unsupported='macos-first-release aarch64-first-release autoit-member-over-1g bytecode-v1-over-4g dmg-blkx-metadata-over-64m egg-compat-member-over-1g legacy-callback-over-1g image-fuzzy-over-contiguous-limit pdf-stream-over-4g script-normalization-over-4g vba-over-4g'
