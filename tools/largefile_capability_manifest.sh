...
required_features='BYTECODE_RUNTIME LARGE_FILE_DEFAULTS LARGE_FILE_QUALIFICATION_TEST MMAP_FOR_CROSSCOMPILING DISABLE_MPOOL ENABLE_FUZZ ENABLE_EXTERNAL_MSPACK ENABLE_JSON_SHARED ENABLE_APP ENABLE_MILTER ENABLE_CLAMONACC ENABLE_MAN_PAGES ENABLE_DOXYGEN ENABLE_EXAMPLES ENABLE_TESTS ENABLE_LIBCLAMAV_ONLY ENABLE_STATIC_LIB ENABLE_SHARED_LIB ENABLE_UNRAR ENABLE_SYSTEMD ENABLE_WERROR ENABLE_ALL_THE_WARNINGS ENABLE_DEBUG ENABLE_EXPERIMENTAL ENABLE_FRESHCLAM_DNS_FIX ENABLE_FRESHCLAM_NO_CACHE ENABLE_STRN_INTERNAL MAINTAINER_MODE OPTIMIZE'
...
required_unsupported='macos-first-release aarch64-first-release autoit-ea06-script-over-1g autoit-ea05-output-over-4g bytecode-v1-over-4g dmg-blkx-metadata-unsorted-over-64m egg-compat-member-over-1g egg-extra-field-over-1g elf-legacy-metadata-over-4g legacy-callback-over-1g image-fuzzy-over-contiguous-limit pdf-stream-over-1g vba-materialized-over-1g'
