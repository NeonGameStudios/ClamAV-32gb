...
manifest has 565 entries: 0 qualified, 141 bounded, 398 pending, and 26
unsupported. It reports 546 release-blocking rows, including 7 required rows
...
gate also rejects relabelling a required parser or matcher as a deliberate
unsupported row through its fixed shared allowlist.
