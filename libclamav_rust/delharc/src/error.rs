...
pub enum LhaError<E> {
    ...
    /// Checksum mismatch.
    Checksum(&'static str),
    /// A caller-configured resource limit was exceeded.
    ResourceLimit(&'static str),
    /// A fallible memory allocation failed.
...
impl<E: fmt::Display> fmt::Display for LhaError<E> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        match self {
            ...
            ResourceLimit(e) => write!(f, "resource limit: {}", e),
            MemoryAllocation(e) => write!(f, "memory allocation: {}", e),
        }
    }
}
...
impl From<LhaError<io::Error>> for io::Error {
    fn from(err: LhaError<io::Error>) -> Self {
        ...
        match err {
            ...
            ResourceLimit(e) => Error::new(ErrorKind::Other, e),
            MemoryAllocation(e) => Error::new(ErrorKind::Other, e),
        }
    }
}
