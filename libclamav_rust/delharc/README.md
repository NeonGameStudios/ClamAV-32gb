...
ClamAV vendoring note
---------------------

This tree is derived from the crates.io `delharc` 0.6.1 release
(crate SHA-256 `1c93ba2617f5094875af777b3e1e5d66e79d7c832e4ae2e25722c965a482e5a1`,
upstream Git commit `969e19d90ddf0a8e93598ac5cf117dfd8d1c2b7d`). ClamAV's local changes add
fallible, caller-bounded cumulative LHA header allocation; preserve distinct
resource and memory-allocation errors; propagate the configured bound across
all archive members; and make the upstream randomized tree stress test
deterministic and self-contained. The upstream MIT and Apache-2.0 license
files are retained alongside this README.
