...
impl PropertyValue {
    ...
    fn parse_property_values(reader: Reader) -> Result<PropertyValue> {
        ...
        let size = reader.checked_collection_count::<PropertySet>(size)?;
...
mod test {
    ...
    #[test]
    fn property_values_reject_an_oversized_declared_count() {
        let mut reader = Reader::new(&[
            0xff, 0xff, 0xff, 0xff, // property-value count
            0, 0, 0, 0, // property ID
        ]);
