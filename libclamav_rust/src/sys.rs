...
pub struct cl_fmap {
    ...
    pub pgsz: u64,
    pub paged: u64,
    pub aging_cursor: u64,
    pub aging_scanned_last: u64,
    pub aging_released_last: u64,
    pub aging_owner: *mut cl_fmap,
    pub aging: bool,
...
pub struct cli_ac_data {
    pub offmatrix: *mut *mut *mut u64,
    pub partsigs: u32,
    pub lsigs: u32,
    pub reloffsigs: u32,
    pub lsigcnt: *mut *mut u32,
    pub lsigsuboff_last: *mut *mut u64,
    pub lsigsuboff_first: *mut *mut u64,
    pub lsig_matches: *mut *mut cli_lsig_matches,
    pub yr_matches: *mut u8,
    pub offset: *mut u64,
    pub macro_lastmatch: [u64; 32usize],
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cli_sz_hash64 {
    pub size: u64,
    pub hashes: cli_sz_hash,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cli_hash_patt {
    pub sizehashes: [cli_htu32; 3usize],
    pub sizehashes64: [*mut cli_sz_hash64; 3usize],
    pub sizehashes64_count: [usize; 3usize],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
mod fmap_layout_tests {
    use super::cl_fmap;
    use std::mem::{align_of, offset_of, size_of};

    #[test]
    fn cl_fmap_layout_matches_c_contract() {
        assert_eq!(size_of::<cl_fmap>(), 312);
        assert_eq!(align_of::<cl_fmap>(), 8);
        assert_eq!(offset_of!(cl_fmap, aging_owner), 80);
        assert_eq!(offset_of!(cl_fmap, offset), 96);
        assert_eq!(offset_of!(cl_fmap, bitmap), 288);
    }
}
