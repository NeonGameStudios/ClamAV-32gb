...
| 7-Zip | Source-fixed and focused-tested | Seek, header-open, member-extraction, output-write, member-name allocation, metadata matching, temporary-file, close, cleanup, and member-limit failures now remain non-clean; broader 7-Zip encrypted/malformed corpus qualification remains open. |
