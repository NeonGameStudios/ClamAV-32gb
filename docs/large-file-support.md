...
certificate. At the current audit point it contains 587 capability rows, with
0 qualified rows and 568 release-blocking bounded, pending, or required-
...
side of the plan: 143 rows are bounded, 418 remain pending, and 26 are
