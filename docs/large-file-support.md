...
certificate. At the current audit point it contains 581 capability rows, with
0 qualified rows and 562 release-blocking bounded, pending, or required-
...
side of the plan: 143 rows are bounded, 412 remain pending, and 26 are
