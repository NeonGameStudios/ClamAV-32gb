...
certificate. At the current audit point it contains 586 capability rows, with
0 qualified rows and 567 release-blocking bounded, pending, or required-
...
side of the plan: 143 rows are bounded, 417 remain pending, and 26 are
