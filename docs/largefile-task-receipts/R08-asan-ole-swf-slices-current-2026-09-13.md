# Task receipt: R08 current-source OLE, VBA, and SWF ASan/UBSan slices
...
- `ole2_map`: 7/7; `ole2_xlm`: 3/3; `vba`: 3/3
- `msexpand`: 8/8; `msexpand_map`: 2/2
- `nulsft`: 8/8; `nulsft_map`: 2/2; `nulsft_corpus`: 1/1
- `swf`: 16/16; `swf_map`: 3/3; `swf_api`: 1/1; `swf_corpus`: 2/2

Total: 56 checks, 0 failures, 0 errors. The runner output contained no ASan,
