# Task receipt: R08 current-source container and mail ASan/UBSan slices
...
- `hwpole2_map`: 5/5; `hwpole2_corpus`: 1/1
- `xdp_map`: 5/5; `xdp`: 3/3
- `mail_api`: 4/4; `mail_map`: 2/2; `mail_partial`: 1/1
- `macho_map`: 3/3

Total: 24 checks, 0 failures, 0 errors. The runner output contained no ASan,
