# Task receipt: R08 current-source graphics and image ASan/UBSan slices
...
- Graphics: `graphics` 9/9, `graphics_map` 2/2, `graphics_corpus` 1/1,
  `graphics_api` 1/1
- GIF: `gif` 16/16, `gif_corpus` 1/1, `gif_api` 1/1
- PNG: `png` 9/9, `png_corpus` 1/1
- TIFF: `tiff` 11/11, `tiff_corpus` 1/1, `tiff_large` 3/3,
  `tiff_map` 2/2
- JPEG: `jpeg_map` 14/14, `jpeg_corpus` 1/1

Total: 73 checks, 0 failures, 0 errors. The runner output contained no ASan,
