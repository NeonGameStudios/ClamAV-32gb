...
corpus contains a complete compressed TOC and an in-range uncompressed
...
and nested scanning. This is bounded XAR TOC/member-handoff evidence, not
complete XAR qualification; sanitizer, certified Linux x86-64, materialized
large-file, production-CVD/service, Sonic1, and release evidence remain open.
