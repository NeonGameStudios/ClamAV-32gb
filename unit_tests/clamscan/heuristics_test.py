...
class TC(testcase.TestCase):
    ...
    def test_hidden_by_strong_indicator(self):
        ...
        assert output.ec == 2  # malformed media is fail-closed

        expected_results = ["Can't parse data ERROR", 'Scanned files: 0', 'Infected files: 0']
        unexpected_results = [' FOUND']
    ...
    def test_allmatch(self):
        ...
        expected_results = ["Can't parse data ERROR", 'Scanned files: 0', 'Infected files: 0']
        self.verify_output(output.out, expected=expected_results, unexpected=[' FOUND'])
